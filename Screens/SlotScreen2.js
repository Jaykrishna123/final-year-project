...
import { StyleSheet, Platform, View, ActivityIndicator, FlatList, Text, Alert, YellowBox,TouchableOpacity} from 'react-native';
import FontAwesome from 'react-native-vector-icons/FontAwesome';

export default class SlotScreen2 extends Component {
...
GetItem (flower_name) {
 ...
 webCall=()=>{
  ...
  return fetch('http://www.json-generator.com/api/json/get/cvDGtFSesy?indent=2')
